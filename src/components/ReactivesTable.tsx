...
export default function ReactivesTable() {
  const [reactives] = useState<Reactive[]>(mockData);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lab-blue-light to-lab-blue p-6">
      {/* Header */}
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center space-x-8">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600">ЛАБОРАТОРНЫЙ ИНСТИТУТ</span>
          </div>
      ...
      <Card className="bg-white/90 backdrop-blur-sm shadow-xl">
        <CardHeader className="bg-lab-blue-light/50 p-6">
          <div className="flex items-center justify-between">
            ...
            <Button className="bg-lab-blue-dark hover:bg-lab-blue text-white">
